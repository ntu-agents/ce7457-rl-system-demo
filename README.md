...
The lecture is delivered as part of the CE7457 Reinforcement Learning course at Nanyang Technological University, Singapore.

## Dependencies
This project uses [uv](https://docs.astral.sh/uv/) to manage Python and the dependencies ([Gymnasium](https://gymnasium.farama.org/), [Matplotlib](https://matplotlib.org/), [NumPy](https://numpy.org/)). Install uv, then from this directory run
